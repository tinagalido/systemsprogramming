 ...
 * (4) Redirect the output to output_without_mutex2.txt 
 *
 * Compile using: cc -O0 threadswomutex2.c -o threadswomutex2 -pthread
 * Run using: ./threadswomutex2 <value>
*/
...
void* threadFunc(void* arg)
{
    ...
    char fileName[] = "output_without_mutext2.txt";
