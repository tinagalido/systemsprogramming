 ...
 * (4) Redirect the output to output_with_mutex.txt
 *
 * Compile using: cc -O0 threadswdmutex.c -o threadswdmutex -pthread
 * Run using: ./threadswdmutex <value>
*/
...
static void* threadFunc(void* arg)
{
    ...
    char fileName[] = "output_with_mutext.txt";
